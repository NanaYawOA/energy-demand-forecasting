...
model_path="models/tensorflow/Calgary_LSTM_model.keras"   # Path to save the trained model
data_path="Data/Clean Data/Calgary_processed_data.csv"    # Path to the preprocessed data
